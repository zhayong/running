...
- (IBAction)loginButtonClick:(UIButton *)sender {
    ...
    if([_username.text isEqualToString:@"yaoju"] && [_password.text isEqualToString:@"123456"]){
        ...
        UIAlertController *alerVc = [UIAlertController alertControllerWithTitle:nil message:@"用户名或密码不正确" preferredStyle:UIAlertControllerStyleAlert];
