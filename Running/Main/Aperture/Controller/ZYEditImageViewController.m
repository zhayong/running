...
@interface ZYEditImageViewController ()
/** scrollView*/
@property(nonatomic,strong)ZYImageScrollView * scrollView;
@end

@implementation ZYEditImageViewController
...
- (void)createUI{
    ...
    _scrollView = [[ZYImageScrollView alloc]init];
